...
<a href="/running" className="dropdown-item">Running</a>
<a href="/climbing" className="dropdown-item">Climbing</a>
<a href="/football" className="dropdown-item">Football</a>
<a href="/tennis" className="dropdown-item">Tennis</a>
<a href="/hiking" className="dropdown-item">Hiking</a>
</div> */